// Local mirrors of the omp shapes used by omp-loom. omp's SDK packages are
...
/**
 * The state shape omp-loom's own API returns to the browser
...
/**
 * omp's RPC host-tool bridge: omp-loom registers host tools (set_host_tools)
